...
<html lang="en-us">
    ...
    <body class="custom-bg-color">
        ...
        <div class="layout">
            ...
            <h1 class="custom-success-txt-color">  
            ...
            <form class="edit_user" method="post" action="../actions/update_user.php">
                ...
                <?php
                    ...
                    if($_SESSION['role'] == "admin"){
                        ...
                        <div class=row>
                            <div class="col-3">
                                <a href="changepassword.php?user='.$show['id_user'].'"
                                    <button class="btn custom-success-color" style="color:white;">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <input type="submit" class="btn custom-success-color btn-lg" style="color:white;"value="Edit">
                    </div>
                </div>
            </div>
